...
// ---------------------
module m4sd(c, /*PORT1*/ a,d,q,w,b, /*PORT-2*/ cx,ax,dx,qx,wx,bx);
input           c, cx;
input    [ 3:0] b, bx;
input    [ 9:0] a, ax;
input    [31:0] d, dx;
...
// -- Порт-1 --
    ...
    .q_a              (q),
// -- Порт-2 --
    .clock1           (c),   // Раскомментировать при надобности
    .address_b        (ax),
    .data_b           (dx),
    .wren_b           (wx),
    .q_b              (qx),
// -- Настойки --
    ...
    .byteena_b        (~bx),  // Активировать ~bx при необходимости
    .clocken0         (1'b1),
    .clocken1         (1'b1),
    .clocken2         (1'b1),
    .clocken3         (1'b1),
...
defparam
    altsyncram_component.init_file                  = "memsd.mif",
// --
