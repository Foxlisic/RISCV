...
// -----------------------------------------------------------------------------
reg         sgn;        // Знак деления
reg  [63:0] q;          // Делимое и остаток
reg  [31:0] d;          // Делитель
// -----------------------------------------------------------------------------
...
// -----------------------------------------------------------------------------
wire [31:0] ptr     = r1 + immi;
wire [31:0] pc4     = pc + 4;
// -----------------------------------------------------------------------------
// Выбор второго операнда (I/R) в зависимости от опкода
wire [31:0] op2     = (opcode == 7'h13) ? immi : r2;
        ...
        4, 6: case (s)
            ...
            0: begin
                ...
                if (r2 == 0) begin
                    ...
                    rw <= 1;
                    x  <= (fn3 == 6) ? 0 : 32'hFFFFFFFF;

                end
                // Специальный случай деления -max на -1
                else if (r1 == 32'h80000000 && r2 == 32'hFFFFFFFF) begin
